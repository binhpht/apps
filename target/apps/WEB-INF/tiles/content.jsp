	...
	<section class="panel">
		<div class="panel-body">
			<div class="page-heading page-heading-md">
				<h2>Tính mức cảnh báo cháy rừng trên tỉnh Quảng Bình</h2>
			</div>
				...
				function initialize() {
					...
					for (i = 0; i < locations.length; i++) {
						marker = new google.maps.Marker({
							...
							icon:'/static/images/level/level'+locations[i][6]+'.png',map: map
							
							
						});
						
						addClickListener(marker,locations,i);
					}
      ...
      var latPoint ;
									...
									for (var icount = 0 ; icount<locations.length; icount++)
										...
										menuItems.push({
											...
											eventName : icount,
											label :'<li>'+locations[icount][0]+'</li>'
										});
										}
									'</ul>'
			...
			<div id="note">
<B> Dữ liêu được cập nhật 1 lần 1 ngày.<br>
Chú thích:
<ul><li>
